			...
			<form action="<%=ORSView.EMPLOYEE_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Designation <span
						...
						name="designation" class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getDesignation())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("designation", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Salary <span
						class="text-danger">*</span></label> <input type="text"
						name="salary" class="form-control" maxlength="15"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Joining Date <span
						...
						value="<%=bean.getJoiningDate() != null ? new SimpleDateFormat("yyyy-MM-dd").format(bean.getJoiningDate()) : ""%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("joiningDate", request)%></div>
				</div>
