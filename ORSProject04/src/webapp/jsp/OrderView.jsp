			...
			<form action="<%=ORSView.ORDER_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Order Date <span
						...
						value="<%=bean.getOrderDate() != null ? new SimpleDateFormat("yyyy-MM-dd").format(bean.getOrderDate()) : ""%>">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Customer Id <span
						class="text-danger">*</span></label> <input type="text"
						name="customerId" class="form-control" maxlength="20"
						value="<%=bean.getCustomerId() > 0 ? bean.getCustomerId() : ""%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("customerId", request)%></div>
				</div>
