...
<%@page import="com.sunilos.p4.ctl.ComplaintCtl"%>
...
<jsp:useBean id="bean" class="com.sunilos.p4.bean.ComplaintBean"
	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.COMPLAINT_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Complaint Code <span
						class="text-danger">*</span></label> <input type="text" name="complaintCode"
						class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getComplaintCode())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("complaintCode", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Customer Name <span
						class="text-danger">*</span></label> <input type="text"
						name="customerName" class="form-control" maxlength="200"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Complaint Type <span
						class="text-danger">*</span></label> <input type="text"
						name="complaintType" class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getComplaintType())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("complaintType", request)%></div>
				</div>
