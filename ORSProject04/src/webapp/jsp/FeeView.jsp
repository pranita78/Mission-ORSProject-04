	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.FEE_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Student Id <span
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Amount <span
						...
						name="amount" class="form-control" maxlength="15"
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Payment Date <span
						...
						value="<%=bean.getPaymentDate() != null ? new SimpleDateFormat("yyyy-MM-dd").format(bean.getPaymentDate()) : ""%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("paymentDate", request)%></div>
				</div>

				<div class="mb-3">
					<label class="form-label fw-semibold">Payment Status <span
					...
					<select name="paymentStatus" class="form-select">
						...
						%>
						<option value="<%=key%>"
							<%=key.equals(bean.getPaymentStatus()) ? "selected" : ""%>>
							<%=statusList.get(key)%>
						</option>
						<%
						}
					...
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("paymentStatus", request)%></div>
				</div>
