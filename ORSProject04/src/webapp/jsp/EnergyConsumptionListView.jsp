	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-lightning-charge me-2"></i> Energy Consumption List
			</h5>
			<div class="d-flex gap-2">
				<a href="#" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Energy Consumption
				</a>
			</div>
		</div>
		...
		<form action="<%=ORSView.ENERGY_CONSUMPTION_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="energyCode"
					...
					placeholder="Search by EnergyCode"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getEnergyCode()%></td>
