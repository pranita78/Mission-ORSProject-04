    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="card-header text-white border-0 py-3 px-4 d-flex justify-content-between align-items-center"
            ...
            <h5 class="mb-0 fw-bold">
                <i class="bi bi-send me-2"></i> Drone Delivery List
            </h5>
            <div class="d-flex gap-2">
                ...
                <a href="<%=ORSView.DRONE_DELIVERY_CTL%>"
                    class="btn btn-sm btn-light text-primary fw-semibold">
                    <i class="bi bi-send-fill me-1"></i> Add Drone Delivery
                </a>
            </div>
        </div>
        ...
        <form action="<%=ORSView.DRONE_DELIVERY_LIST_CTL%>" method="POST">
            ...
            <div class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
                <input type="text" name="droneCode"
                    class="form-control form-control-sm" style="max-width: 180px;"
                    placeholder="Search by Drone Code"
                ...
                <button type="submit" name="operation"
                    value="<%=BaseCtl.OP_DELETE%>" class="btn btn-danger btn-sm ms-auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ("In Flight".equals(st)) stBadge = "primary";
                                else if ("Active".equals(st)) stBadge = "success";
                                else if ("Maintenance".equals(st)) stBadge = "danger";
                                else if ("Idle".equals(st)) stBadge = "warning";
                                %>
