	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-file-earmark-text me-2"></i> Exam List
			</h5>
			<div class="d-flex gap-2">
				<a href="#" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add Exam
				</a>
			</div>
		</div>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getExamName()%></td>
							<td><%=bean.getExamDate()%></td>
							<td><%=bean.getTotalMarks()%></td>
							<td><%=bean.getPassingMarks()%></td>
