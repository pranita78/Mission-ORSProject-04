	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-card-checklist me-2"></i> Subscription List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.SUBSCRIPTION_CTL%>"
					class="btn btn-sm btn-light text-primary fw-semibold"> <i
					class="bi bi-card-checklist me-1"></i> Add Subscription
				</a>
			</div>
		</div>
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="SubscriptionCtl?id=<%=bean.getId()%>"
