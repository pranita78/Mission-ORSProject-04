			...
			<form action="<%=ORSView.HOTEL_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Hotel Name <span
						class="text-danger">*</span></label> <input type="text" name="hotelName"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getHotelName())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("hotelName", request)%></div>
				</div>
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Rating <span
						class="text-danger">*</span></label> <input type="text"
						name="rating" class="form-control" maxlength="5"
						value="<%=DataUtility.getStringData(bean.getRating())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("rating", request)%></div>
				</div>
