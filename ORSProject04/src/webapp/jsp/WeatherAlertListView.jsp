	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-cloud-lightning me-2"></i> Weather Alert List
			</h5>
			<div class="d-flex gap-2">
				...
				</a> <a href="<%=ORSView.WEATHER_ALERT_CTL%>"
		...
		<form action="<%=ORSView.WEATHER_ALERT_LIST_CTL%>" method="POST">
			<input type="hidden" name="pageNo" value="<%=pageNo%>"> <input
				type="hidden" name="pageSize" value="<%=pageSize%>">

			<div
				class="p-3 bg-light border-bottom d-flex flex-wrap gap-2 align-items-center">
				<input type="text" name="alertCode"
					class="form-control form-control-sm" style="max-width: 220px;"
					placeholder="Search by AlertCode"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="WeatherAlertCtl?id=<%=bean.getId()%>"
