	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div
			...
			<h5 class="mb-0 fw-bold">
				<i class="bi bi-cpu me-2"></i> AI Recommendation List
			</h5>
			<div class="d-flex gap-2">
				<a href="#" target="_blank"
					...
					class="bi bi-plus-circle me-1"></i> Add AI Recommendation
				</a>
			</div>
		</div>
		...
		<form action="<%=ORSView.AI_RECOMMENDATION_LIST_CTL%>" method="POST">
			...
			<div
				...
				<input type="text" name="recommendationCode"
					...
					placeholder="Search by RecommendationCode"
				...
				<table class="table table-hover align-middle mb-0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="fw-semibold"><%=bean.getRecommendationCode()%></td>
