	...
	<div class="card border-0 shadow-sm rounded-4 overflow-hidden">
		...
		<div class="card-body px-4 py-4">
			...
			<form action="<%=ORSView.VOICE_COMMAND_CTL%>" method="POST">
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Command Code <span
						class="text-danger">*</span></label> <input type="text" name="commandCode"
						class="form-control" maxlength="100"
						value="<%=DataUtility.getStringData(bean.getCommandCode())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("commandCode", request)%></div>
				</div>
				...
				<div class="mb-3">
					<label class="form-label fw-semibold">Command Text <span
						class="text-danger">*</span></label> <input type="text" name="commandText"
						class="form-control" maxlength="200"
						value="<%=DataUtility.getStringData(bean.getCommandText())%>">
					<div class="text-danger small mt-1"><%=ServletUtility.getErrorMessage("commandText", request)%></div>
				</div>
